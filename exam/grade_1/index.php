<?php 
session_start();
if (isset($_SESSION['grade1_id']) && 
    isset($_SESSION['role'])) 

    if ($_SESSION['role'] == 'grade_1') 
 ?>
...
if($rowcount == 0){
	...
	<td><b><a href="update.php?q=quiz&step=2&eid='.$eid.'&n=1&t='.$total.'" class="pull-right btn sub1" style="margin:0px;background:#99cc32"><span class="glyphicon glyphicon-new-window" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Start</b></span></a></b></td></tr>';
}
else
{
